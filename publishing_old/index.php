                    ...
                    <div class="reviewSlider">
                        ...
                        <div>
                            <div class="reviewBox">
                                ...
                                <p>I've been collaborating with  <?php echo WEBSITE_NAME ?> for a year and have already published one successful
    ...
    <footer class=" bg-dark py-5">
        <div class="container text-center">
            <a href="javascript:;" class=" user-select-none pe-none">
                <img loading="lazy" src="assets/images/logo.png" style="filter: brightness(0) invert(1);" alt="image" width="250" height="90"
                    style="object-fit: contain;" class=" mx-auto">
            </a>
      ...
      <div class="entry-box">
         <form class="offr-frm form_submission" method="POST">
            ...
            <div class="col-sm-12 entry-right">
               ...
               <div class="col-sm-12">
                  <div class="form-group">
                     <input type="number" class="form-control number" name="phone" placeholder="Phone" minlength="11" maxlength="12" required="">
                  </div>
               </div>
               <div class="col-sm-12">
