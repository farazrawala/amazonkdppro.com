...
<head>
    ...
    <link rel="canonical" href="https://www.amazonkdpexperts.com/publishing2" />
            ...
            <div class="row align-items-center">
                <div class="col-md-3">
                    <div class="logo text-center">
                        <a href="https://amazonkdpexperts.com/publishing/"><img src="assets/images/logo.png" alt="logo"></a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="offset-lg-1 col-lg-5 col-md-12">
                        <div class="form-box text-white text-center  py-5 px-5">
                            ...
                            <h3 class="fs-3 lh-base blinking-text">For November 2025 Only!<br>UP TO 50% OFF ON</h3>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="footer_inner">
                        ...
                        <a href="https://amazonkdpexperts.com/publishing/" class="d-block">
            ...
            <div class="row mt-5 justify-content-between">
                <div class="col-md-4">
                    <div class="privacy ">
                        <a href="
                  https://www.amazonkdpexperts.com/privacy">Privacy-Policy</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="privacy text-end">
                        <a href="https://www.amazonkdpexperts.com/terms
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="bottom_line">
                        <p> © 2025 <?php echo WEBSITE_NAME ?> All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content custom-modal">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="post" class="popup-form mt-3 form_submission">
                        ...
                        <input type="hidden" name="link" value="https://www.amazonkdpexperts.com/publishing/">
