...
<link href="assets/css/m-style.css?30-06-26_06:08:59" rel="stylesheet" rel="preload" as="style" type="text/css" />
<link href="assets/css/style.css?30-06-26_06:08:59" rel="stylesheet" rel="preload" as="style" type="text/css" />
<link href="assets/css/newcss.css?30-06-26_06:08:59" rel="stylesheet" rel="preload" as="style"type="text/css" />
						...
						<div class="col-md-6">
							<div class="formwrp">
								<img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/Path-973.svg">
								    <form  action="https://thebookprofessionals.com/publishing-experts/assets/css/assets/css/assets/js/assets/js/lazyload.min.js" method="post">
								
                                    <input type="hidden" name="ip" value="110.93.236.214">
                                    <input type="hidden" name="city" value="">
                                    <input type="hidden" name="region" value="">
                                    <input type="hidden" name="country" value="">
                                    <input type="hidden" name="url" value='https://thebookprofessionals.com/publishing-experts/assets/css/assets/css/assets/js/assets/js/lazyload.min.js   '>
                                    <input type="hidden" name="domain" value="thebookprofessionals.com">
                                    <input type="hidden" name="subject" value="Banner Form (https://thebookprofessionals.com/publishing-experts/assets/css/assets/css/assets/js/assets/js/lazyload.min.js)">
									<!--<div class="lablewrp">-->
					...
					<div class="row">
                        ...
                        <div>
                        	<form action="https://thebookprofessionals.com/publishing-experts/assets/css/assets/css/assets/js/assets/js/lazyload.min.js" method="post">
									...
									<input type="hidden" name="subject" value="Pop Up Form (https://thebookprofessionals.com/publishing-experts/assets/css/assets/css/assets/js/assets/js/lazyload.min.js)">
                        <div class="row">
                          <div class="col-md-6">
  ...
  <div class="modal-dialog">
    <div class="modal-content ">
      ...
      <div class="modal-body formwrp">
       <form class="" action="https://thebookprofessionals.com/publishing-experts/assets/css/assets/css/assets/js/assets/js/lazyload.min.js" method="post">
